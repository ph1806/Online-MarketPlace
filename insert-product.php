...
if(isset($_POST['submit']))
{
   ...
   $productscharge=$_POST['productpricebd'];
	
	$productdescription=$_POST['productDescription'];
	$productimage1=$_FILES["productimage1"]["name"];
//for getting product id
$query=mysqli_query($con,"select max(L_ID) as lid from laptop");
	$result=mysqli_fetch_array($query);
	 $productid=$result['lid']+1;
	$dir="productimages";
    $abc="productimages/".$productimage1;
    
        

	move_uploaded_file($_FILES["productimage1"]["tmp_name"],"productimages/".$_FILES["productimage1"]["name"]);
	$query1="insert into laptop(L_ID,ID,Title,Des,Seeking,img_src,submitted) values('','$ID','$productname','$productdescription','$productscharge','$abc','')";
